<?php
//CRUD genérico feito em sala para utilização em estudos seguintes
...
class Database
{
    ...
    public function __construct()
    {
        ...
        try {
            ...
            $this->conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION); //o PDO não lança exceções automaticamente, é necessário alterar o atributo
